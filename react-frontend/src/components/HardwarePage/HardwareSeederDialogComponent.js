...
import seederData from "./hardware.seeder.json";
...
const HardwareSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(HardwareSeederDialogComponent);
