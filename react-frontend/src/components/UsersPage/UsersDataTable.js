...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.tennant}</p>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="tennant" header="tennant" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="isAdmin" header="Admin" body={tickTemplate4} style={{ minWidth: "8rem" }} />
